...
save_model_dir = '../checkpoints_fp16'
...
def args():
    ...
    parser.add_argument("--batch_size_on_eval", type=int, default=8)
...
def main(args):
    ...
    wandb.init(project="m_t5_fine_tune")
    ...
    args = Seq2SeqTrainingArguments(                        
        ...
        fp16=True,                          #fp16精度对显存需求更小，运算更快
        fp16_opt_level='O0',
        half_precision_backend='apex',      #需要安装apex
        save_strategy='epoch', 
...
def preprocess_function(examples):          #数据预处理
    inputs = [line for line in examples['src']] 
