...
#语料路径
train_csv = '/home/ysp2018/projects/m_t5/data/baseline_train_orgin.csv'
valid_csv = '/home/ysp2018/projects/m_t5/data/baseline_valid_orgin.csv'
test_csv = '/home/ysp2018/projects/m_t5/data/baseline_test_orgin.csv'

save_model_dir = '../baseline_orgin_checkpoints'

#加载model和tokenizer
tokenizer = MT5Tokenizer.from_pretrained('/home/ysp2018/projects/m_t5/model')
mt5model = MT5ForConditionalGeneration.from_pretrained('/home/ysp2018/projects/m_t5/model')
...
def main(args):
    ...
    wandb.init(project="baseline_orgin")
