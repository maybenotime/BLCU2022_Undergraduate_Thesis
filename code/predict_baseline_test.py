...
test_path = '/home/ysp2018/projects/m_t5/data/baseline_test.csv'
save_path = '/home/ysp2018/projects/m_t5/inference_result/baseline_mt5_test_result.txt'
...
def args():
    ...
    parser.add_argument("--model_path", type=str, default='/home/ysp2018/projects/m_t5/baseline_checkpoints/checkpoint-556066')
