...
test_path = '/home/ysp2018/projects/m_t5/baseline_easy_noram_hard_data/hard_test.txt.csv'
save_path = '/home/ysp2018/projects/m_t5/inference_result/baseline_hard_test_result.txt'
...
def args():
    ...
    parser.add_argument("--model_path", type=str, default='/home/ysp2018/projects/m_t5/baseline_transfer_hard_checkpoints/checkpoint-145251')
