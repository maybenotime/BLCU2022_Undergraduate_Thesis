...
test_path = '/home/ysp2018/projects/m_t5/data/baseline_test_orgin.csv'
save_path = '/home/ysp2018/projects/m_t5/inference_result/baseline_origin_mt5_test_result.txt'
...
def args():
    ...
    parser.add_argument("--model_path", type=str, default='/home/ysp2018/projects/m_t5/baseline_orgin_checkpoints/checkpoint-556066')
