...
#语料路径
train_csv = '/home/ysp2018/projects/m_t5/baseline_easy_noram_hard_data/easy_train.txt.csv'
valid_csv = '/home/ysp2018/projects/m_t5/baseline_easy_noram_hard_data/easy_valid.txt.csv'
test_csv = '/home/ysp2018/projects/m_t5/baseline_easy_noram_hard_data/easy_test.txt.csv'

save_model_dir = '../baseline_transfer_easy_checkpoints'

#加载model和tokenizer
tokenizer = MT5Tokenizer.from_pretrained('/home/ysp2018/projects/m_t5/baseline_transfer_easy_checkpoints/checkpoint')
mt5model = MT5ForConditionalGeneration.from_pretrained('/home/ysp2018/projects/m_t5/baseline_transfer_easy_checkpoints/checkpoint')
...
def main(args):
    ...
    wandb.init(project="baseline_easy_transfer")
