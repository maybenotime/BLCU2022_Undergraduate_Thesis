...
save_model_dir = '../checkpoints_prefix_tuning'

#加载model和tokenizer
tokenizer = MT5Tokenizer.from_pretrained('/home/ysp2018/projects/m_t5/model_for_prefixtuning/checkpoint-476616')
mt5model = MT5ForConditionalGeneration.from_pretrained('/home/ysp2018/projects/m_t5/model_for_prefixtuning/checkpoint-476616')
...
def main(args):
    ...
    wandb.init(project="mt5_prefix_tuning")
